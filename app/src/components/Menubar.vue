 <template>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <a class="navbar-brand order-0 mr-4" href="#">EEG Visualizer</a>
    <select-file class="order-1 mr-2"/>
    <a class="nav-link" @click="goBack" id="Back">Back</a>
    <template v-if="this.isFileLoaded">
      ...
      <form class="order-3 ml-auto form-inline">
        ...
        <button class="nav-link" v-on:click="goToLeft" type="button">🡄</button>
        <button class="nav-link" v-on:click="goToRight" type="button">🡆</button>
      </form>
    </template>
  </nav>
</template>
...
.navbar {
  padding: 5px 0; /* Adjust padding to your preference */
  font-size: 14px; /* Adjust font size to your preference */
  height: 10  dvh; /* Adjust the height as needed */
}

/* Customize the size of the navbar brand */
.navbar-brand {
  padding: 5px 10px; /* Adjust padding to your preference */
  margin: 0 10px; /* Adjust margin to your preference */
}

/* Customize the size of the back button */
.nav-link {
  font-size: 14px; /* Adjust font size to your preference */
  padding: 0 5px; /* Adjust padding to your preference */
}
#Back{
  cursor: pointer;
}
